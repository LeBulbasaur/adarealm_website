...
export default function Navbar() {
  ...
  let { connectWallet, firebaseUser, logoutUser } = useAuth();
    ...
    <>
      <nav className="navbar__main">
        ...
        {!isOpen ? (
          ...
          >
            <path
              d="M25.3332 6.66669L6.6665 25.3334"
              stroke="#F0F0F0"
              strokeWidth="2"
              strokeLinecap="round"
              strokeLinejoin="round"
            />
            <path
              d="M6.6665 6.66669L25.3332 25.3334"
              stroke="#F0F0F0"
              strokeWidth="2"
              strokeLinecap="round"
              strokeLinejoin="round"
