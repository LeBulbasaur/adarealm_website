        ...
        <footer className="footer__main">
            <div className="footer__content">
                ...
                <div className="footer__contact">
                    <h5>Contact</h5>
                    <p>Interested in collaboration? <br />Drop us a message:</p>
                    <p className="footer__email"
                        onClick={() => {
                            navigator.clipboard.writeText("adarealm@email.com");
                        }}
                    >
                        adarealm@email.com</p>
                    <div className="footer__social__logos">
                        <a href="https://discord.gg/VsMxxmTU" target="_blank">
                            <svg width="50" height="50" viewBox="0 0 57 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="https://twitter.com/AdaRealm" target="_blank">
                            <svg width="50" height="50" viewBox="0 0 53 42" fill="none" xmlns="http://www.w3.org/2000/svg">
