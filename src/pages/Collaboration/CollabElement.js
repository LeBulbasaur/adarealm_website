...
export default function CollabElement({
  ...
  return (
    <div className="collaboration__box">
      <div className="collaboration__img__box">
        <img src={photo} alt="collab logo" className="collaboration__img" />
      </div>
      <h4>{name}</h4>
      <p>{description}</p>
      <a href={link} target="_blank">
        <div className="gray__button__collab">Visit their website</div>
      </a>
